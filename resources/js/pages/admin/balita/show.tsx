                            ...
                            <TableContainer>
                                <Table className="w-full border-collapse">
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow className="border-b">
                                            <TableColumn className="text-foreground p-3 font-medium">Nama Balita/Anak</TableColumn>
                                    ...
                                    <Table className="w-full">
                                        <TableHead>
                                            <TableRow>
                                                ...
                                                <TableHead className="px-0">Tanggal Pemeriksaan</TableHead>
                                                {attribut.length > 0 && attribut.map((item) => <TableHead key={item.id}> {item.nama}</TableHead>)}
                                            </TableRow>
                                        </TableHead>
                                        <TableBody>
